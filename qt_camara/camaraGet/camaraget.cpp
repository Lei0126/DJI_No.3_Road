...
void camaraGet::savingPictures()
{
    ...
    //默认保存路径为当前应用程序路径下的ScreenShot文件夹，如果没有就新建该文件夹
        ...
        Mat img = imread("/work/qt_dir/qt_camara/pictures/1.jpg",1);
...
***openpic***
********************************/
void camaraGet::openningPictures()
{
...
void camaraGet::on_pushButton_clicked()
{
  digitalWrite(0, LOW);
}

void camaraGet::on_pushButton_2_clicked()
{
  digitalWrite(0, HIGH);
}
