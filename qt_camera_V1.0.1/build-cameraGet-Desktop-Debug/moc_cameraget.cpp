...
struct qt_meta_stringdata_camaraGet_t {
    QByteArrayData data[10];
    char stringdata0[137];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_camaraGet_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_camaraGet_t qt_meta_stringdata_camaraGet = {
    {
QT_MOC_LITERAL(0, 0, 9), // "camaraGet"
QT_MOC_LITERAL(1, 10, 10), // "openCamara"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 9), // "readFarme"
QT_MOC_LITERAL(4, 32, 11), // "closeCamara"
...
QT_MOC_LITERAL(9, 113, 23) // "on_pushButton_2_clicked"
    ...
    "camaraGet\0openCamara\0\0readFarme\0"
    "closeCamara\0takingPictures\0savingPictures\0"
...
const QMetaObject camaraGet::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_camaraGet.data,
      qt_meta_data_camaraGet,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *camaraGet::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_camaraGet.stringdata0))
